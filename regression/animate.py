...
class AnimateGradiendDescent:
    ...
    def update(self,frame):
        ...
        self.ax.set_title(f'error {error}')
        self.line.set_data(self.X, self.model.predict(self.X))
    ...
    def animate(self):
        self.ax.plot(self.X, self.Y, 'bo', label='Initial Data')  # Plot X and Y as blue dots
